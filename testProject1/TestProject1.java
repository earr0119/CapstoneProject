...
public class TestProject1 {
	...
	static Clothing[] stock = { new Clothing("M0001", "BLUE JEAN", "L", 18.99f),
			new Clothing("M0002", "BLUE JEAN SHORTS", "M", 15.25f),
			new Clothing("M0003", "ORANGE T-SHIRT", "L", 11.99f), new Clothing("M0004", "GREEN T-SHIRT", "XL", 13.99f),
			new Clothing("M0005", "BLACK JACKET", "L", 29.5f), new Clothing("M0006", "ORANGE SHORT", "M", 9.99f),
			new Clothing("M0007", "UNDERWEARS SET", "L", 20.99f), new Clothing("M0008", "SOCKS SET", "M", 15.5f),
			new Clothing("M0009", "BRONW BELT", "XL", 11.8f), new Clothing("M0010", "BLACK BELT", "L", 10.5f), };

	static List<Clothing> shoppingCar = new ArrayList<>();
...
//***********************************************************************************************//
	...
	static void ShowRegisterClientMenu() {
		...
		do {
			...
			if (Objects.equals(genderClient, "F") || Objects.equals(genderClient, "M")
					|| Objects.equals(genderClient, "X")) {
